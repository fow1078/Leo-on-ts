      ...
      {addOrBackBtn === 'timelock' && 
        <Container>
          ...
          <div style={{display: 'flex', justifyContent: 'start', alignItems: 'center', width: '100%', position: 'relative'}}>
            ...
            <ItemTitle>{t('res_wallet')}</ItemTitle>
          </div>
          <AddNewMenuContainer>
            <WrapperSubTitle>Remember, you can not cancel this action, current wallet will be deleted</WrapperSubTitle>
            <AddNewInput type={'text'} placeholder={'Password'}/>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
              ...
              <Button style={{ width: '150px', backgroundColor: '#285BFE', borderRadius: '10px' }} label={t('reset')} onPress={() => {}} />
            </div>
          </AddNewMenuContainer>
        </Container>
      }
