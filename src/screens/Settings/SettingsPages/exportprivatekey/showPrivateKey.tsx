    ...
    <>
      {addOrBackBtn === 'exportkey' && 
        <Container>
          ...
          <AddNewMenuContainer>
            <WrapperSubTitle>Never share your private key...</WrapperSubTitle>
            <AddNewInput type={'text'} placeholder={'Password'} name={'Change auto lock time'}/>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
              <Button style={{ width: '100%', backgroundColor: '#285BFE', borderRadius: '10px' }} label={t('close')} onPress={() => setAddOrBackBtn('sett')} />
            </div>
          </AddNewMenuContainer>
        </Container>
      }
